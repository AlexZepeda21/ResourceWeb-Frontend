...
return(
    <>
     <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6">
      <div className="flex bg-white shadow-md rounded-lg overflow-hidden w-full max-w-4xl">
        {/* Carta de foto perfil */}
        <div className="bg-gray-50 p-6 w-1/3 flex flex-col items-center text-center">
          <img
          ...
          <button className="bg-red-500 text-white px-4 py-2 rounded mb-2 hover:bg-red-600">
            Actualizar Foto de Perfil
          </button>
          <p className="text-gray-400 text-sm mt-2">Miembro desde: </p>
        </div>
        ...
        <div className="p-6 w-2/3">
          ...
          <form>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-gray-700">Cofirmar Correo</label>
                <input
                  type="email"
                  name="confirmEmail"
                  className="mt-1 p-2 border rounded w-full"
