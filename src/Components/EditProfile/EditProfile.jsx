        ...
        <div className="flex space-x-8">
          ...
          { <div className="w-48 bg-white p-4 rounded shadow">
            <ul className="space-y-2">
              <li className="font-semibold text-blue-500">Profile Settings</li>
              <li className="hover:text-blue-500 cursor-pointer">Password</li>
              <li className="hover:text-blue-500 cursor-pointer">Notifications</li>
              <li className="hover:text-blue-500 cursor-pointer">Verification</li>
            </ul>
          </div>
 }
          {/* Form */}
          <div className="flex-1 bg-white p-6 rounded shadow space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="space-x-2">
                <button className="bg-blue-500 text-white px-4 py-2 rounded">Actualizar Foto</button>
                <button className="bg-gray-300 px-4 py-2 rounded">Eliminar Foto</button>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <input
                type="date"
                name="taxId"
                className="border p-2 rounded w-4/8"
              />
              </div>
            </div>
            <button
